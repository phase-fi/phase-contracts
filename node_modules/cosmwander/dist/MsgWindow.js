...
const CodeWindow_1 = __importDefault(require("./MsgWindow/CodeWindow"));
const ContractInstanceWindow_1 = __importDefault(require("./MsgWindow/ContractInstanceWindow"));
const ContractWindow_1 = __importDefault(require("./MsgWindow/ContractWindow"));
const MsgWindow = ({
  height
}) => {
  const {
